...
def set_small_default_category():
    ...
    small_category, _ = SmallCategory.objects.get_or_create(
        small_category="その他", big_category=big_category
    )
...
class Item(models.Model):
    ...
    big_category = models.ForeignKey(
        BigCategory, on_delete=models.SET_DEFAULT, default=set_big_default_category
    )
    small_category = models.ForeignKey(
        SmallCategory, on_delete=models.SET_DEFAULT, default=set_small_default_category
    )
